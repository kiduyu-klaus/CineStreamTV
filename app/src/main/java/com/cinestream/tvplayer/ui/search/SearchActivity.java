package com.cinestream.tvplayer.ui.search;
...
import com.cinestream.tvplayer.data.repository.TMDBRepository;
import com.cinestream.tvplayer.ui.adapter.SearchResultsAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private TMDBApiClient.ContentType currentFilter = TMDBApiClient.ContentType.ALL;
    ...
    private void setupListeners() {
        ...
        // Filter buttons
        filterAllButton.setOnClickListener(v -> setFilter(TMDBApiClient.ContentType.ALL));
        filterMoviesButton.setOnClickListener(v -> setFilter(TMDBApiClient.ContentType.MOVIE));
        filterTVButton.setOnClickListener(v -> setFilter(TMDBApiClient.ContentType.TV));
    ...
    private void loadInitialData() {
        ...
        tmdbRepository.getTrendingSearches(new TMDBRepository.TMDBCallback<List<String>>() {
            @Override
    ...
    private void setFilter(TMDBApiClient.ContentType filter) {
    ...
    private TMDBRepository.TMDBCallback<List<MediaItems>> searchCallback = new TMDBRepository.TMDBCallback<List<MediaItems>>() {
        @Override
